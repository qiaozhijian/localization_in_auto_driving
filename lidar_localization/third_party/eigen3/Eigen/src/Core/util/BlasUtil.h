...
public:
    ...
    EIGEN_ALWAYS_INLINE LinearMapper
    getLinearMapper(Index
    i,
    Index j
    ) const {
    ...
    EIGEN_ALWAYS_INLINE VectorMapper
    getVectorMapper(Index
    i,
    Index j
    ) const {
