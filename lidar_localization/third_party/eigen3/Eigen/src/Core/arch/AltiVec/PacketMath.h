...
// These constants are endian-agnostic
        ...
        static Packet4f p4f_ZERO_ = (Packet4f) vec_sl((Packet4ui) p4i_MINUS1,
...
// Need to define them first or we get specialization after instantiation errors
        ...
        plset<Packet4f>(const float &a) { return vec_add(pset1<Packet4f>(a), p4f_COUNTDOWN); }

        template<> EIGEN_STRONG_INLINE Packet4i

        plset<Packet4i>(const int &a) { return vec_add(pset1<Packet4i>(a), p4i_COUNTDOWN); }
...
// We also need ot redefine little endian loading of Packet4i/Packet4f using VSX
        ...
        preverse(const Packet4f &a) { return (Packet4f) vec_perm((Packet16uc) a, (Packet16uc) a, p16uc_REVERSE32); }

        template<> EIGEN_STRONG_INLINE Packet4i

        preverse(const Packet4i &a) { return (Packet4i) vec_perm((Packet16uc) a, (Packet16uc) a, p16uc_REVERSE32); }
